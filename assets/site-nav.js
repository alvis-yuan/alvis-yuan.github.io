(function () {
  ...
  function collectHeadings() {
    var headingNodes = Array.prototype.slice.call(document.querySelectorAll('h1, h2, h3'));
    ...
    headingNodes.forEach(function (node) {
      ...
      var anchorNode = node;
      var sectionAnchor = level === 2 ? node.closest('section[id]') : null;
      if (sectionAnchor && sectionAnchor.id) {
        anchorNode = sectionAnchor;
      }
      if (!anchorNode.id) {
